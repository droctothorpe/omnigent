        ...
        async with self._inject_lock:
            ...
            if state is None:
                ...
                error_msg = (
                    ...
                    if startup_error
                    else "Codex native bridge state is missing: the Codex TUI "
                    "has not started its thread yet (it may still be "
                    "cold-starting). Wait for the session terminal to settle, "
